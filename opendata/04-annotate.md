# Day 4 - annotate Gem - Annotate Your ActiveRecord Models with Comments about Your Database Table Structure
...
- Gem      :: [annotate](https://rubygems.org/gems/annotate)
- Docs     :: [annotate](http://rubydoc.info/gems/annotate)
