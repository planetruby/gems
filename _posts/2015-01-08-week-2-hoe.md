...
## Set up Hoe by adding a build script, readme, change log and manifest

To use Hoe together with your own code use the following structure.

Note: You can grab all files from this post from the [`hellohoe` GitHub repository](https://github.com/geraldb/hellohoe).
...
That will create a new directory `my_new_project` with a skeletal project inside. You need to edit the
...
Source: [Hoe PDF Booklet](http://docs.seattlerb.org/hoe/Hoe.pdf) - 6 Pages
