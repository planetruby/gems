...
Lets thank Ryan Tomayko, Magnus Holm and friends
that have created the tilt gem offering a standard "generic" interface
for template engines that you can use for - surprise, surprise - building your own 
web frameworks or static site generators, for example.


Let's check-up what formats and template engines are included:
...
Wow. That's quit an offering. Lets see Tilt in action and 
...
The proof of the pudding. To wrap up lets fire up Almost Sinatra II with an example
